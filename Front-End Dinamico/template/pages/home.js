export function home(Navegar) {
    ...
    h3.innerHTML = 'Precisa de uma ajudinha com o churrasco? :) <br><br> Quantas pessoas vão participar?'
    ...
    // Cria o id e o texto de cada bloco
    ...
    calcular.addEventListener('click', function () {
        ...
        // esta função é importada de index.js
        Navegar('result')
    })
